...
namespace SalonWebApi.Migrations
{
    ...
    [Migration("20201206152501_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalonWebApi.Models.ToDoItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SalonWebApi.Models.CarShowroom", b =>
                {
                    b.HasOne("SalonWebApi.Models.CarShowroomContainer", "CarShowroomContainer")
                        .WithMany("salons")
                        .HasForeignKey("CarShowroomContainerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CarShowroomContainer");
                });
            ...
            modelBuilder.Entity("SalonWebApi.Models.Vehicle", b =>
                {
                    b.HasOne("SalonWebApi.Models.CarShowroom", "CarShowroom")
                        .WithMany("CarList")
                        .HasForeignKey("CarShowroomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
